...
function(GETTEXT_PROCESS_PO_FILES _lang)
   ...
   foreach(_current_PO_FILE ${_parsedArguments_PO_FILES})
      ...
      set(_gmoFile ${CMAKE_CURRENT_BINARY_DIR}/${_lang}_${_basename}.gmo)
      ...
      if(_parsedArguments_INSTALL_DESTINATION)
         install(FILES ${CMAKE_CURRENT_BINARY_DIR}/${_lang}_${_basename}.gmo DESTINATION ${_parsedArguments_INSTALL_DESTINATION}/${_lang}/LC_MESSAGES/ RENAME ${_basename}.mo)
      endif()
      list(APPEND _gmoFiles ${_gmoFile})
   endforeach()
