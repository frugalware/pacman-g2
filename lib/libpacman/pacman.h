...
enum {
	...
	PM_TRANS_EVT_FILECONFLICTS_PROGRESS,
	PM_TRANS_EVT_INTERCONFLICTS_PROGRESS,
	PM_TRANS_EVT_ADD_PROGRESS,
	PM_TRANS_EVT_REMOVE_PROGRESS,
	PM_TRANS_EVT_UPGRADE_PROGRESS,
};
...
enum {
	PM_TRANS_PROGRESS_ADD_START = PM_TRANS_EVT_ADD_PROGRESS,
	PM_TRANS_PROGRESS_UPGRADE_START = PM_TRANS_EVT_UPGRADE_PROGRESS,
	PM_TRANS_PROGRESS_REMOVE_START = PM_TRANS_EVT_REMOVE_PROGRESS,
	PM_TRANS_PROGRESS_CONFLICTS_START = PM_TRANS_EVT_FILECONFLICTS_PROGRESS,
	PM_TRANS_PROGRESS_INTERCONFLICTS_START = PM_TRANS_EVT_INTERCONFLICTS_PROGRESS,
};
