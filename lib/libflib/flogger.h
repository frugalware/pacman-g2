...
typedef struct FLoggerOperations FLoggerOperations;

struct FLoggerOperations {
	FObjectOperations as_FObjectOperations;
	void (*vlog) (FLogger *logger, unsigned flag, const char *format, va_list ap);
};
